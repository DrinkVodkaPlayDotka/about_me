...
.nav a::before {
  ...
  right: 0;
  top: 0;
  border-top: 3px solid #ee8241;
  border-right: 3px solid #c28341;
...
.nav a:after {
  ...
  left: 0;
  bottom: 0;
  border-bottom: 3px solid #c28341;
  border-left: 3px solid #ee8241;
  transform: translate(100%, -50%)
}
...
.rgb {
  background: linear-gradient(45deg, #ee8241 33%, #c28341 66%, #9f58c9);
